...
(function () {
    ...
    Morris.Bar = (function (_super) {
        ...
        Bar.prototype.calc = function () {
            var _ref;
            if(!this.options.horizontal && this.options.barSize && (this.xSize/this.options.data.length)>(this.options.barSize+this.options.barGap)){
                var _xSize = (this.options.barSize+this.options.barGap)*this.options.data.length;
                this.xPadding = (this.xSize - _xSize)/2;
                this.xSize = _xSize;
            }
            this.calcBars();
            if (this.options.hideHover === false) {
        ...
        Bar.prototype.calcBars = function () {
            ...
            for (idx = _i = 0, _len = _ref.length; _i < _len; idx = ++_i) {
                row = _ref[idx];
                row._x = this.xPadding + this.xStart + this.xSize * (idx + 0.5) / this.data.length;
        ...
        Bar.prototype.drawXAxis = function () {
            var angle, basePos, i, label, labelBox, margin, maxSize, offset, prevAngleMargin, prevLabelMargin, row, size, startPos, textBox, _i, _ref, _results_labelRef;
            if (!this.options.horizontal) {
                basePos = this.getXAxisLabelY();
            } else {
                basePos = this.getYAxisLabelX();
                    ...
                    for(;_labelCheck>=0;_labelCheck--){
                        if(_results[_labelCheck] !== undefined){
                            ...
                            if(_tempLabel !== undefined ? (_tempLabel.includes("\n") && !_tempLabel.includes("\n~")) : false){
                                ...
                                if(_results[_labelCheck] >= startPos + size){
                        ...
                        if(i!==0){
                            for(;_labelCheck>_labelRef.length;_labelCheck++){
                                if(_results[_labelCheck] !== undefined){
                                    ...
                                    _labelRef[_labelCheck]=undefined;
                                }
                            }
                        }
                        if (!this.options.horizontal) {
                        ...
                        for (sidx = _k = 0, _len1 = _ref2.length; _k < _len1; sidx = ++_k) {
                            ...
                            if (ypos !== null) {
                                ...
                                if (this.options.verticalGridCondition && this.options.verticalGridCondition(row.x)) {
                                    if (!this.options.horizontal) {
                                        this.drawBar(this.xPadding + this.xStart + idx * groupWidth, this.yEnd, groupWidth, this.ySize, this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius);
                                    } else {
        ...
        Bar.prototype.hitTest = function (x, y) {
            ...
            if (!this.options.horizontal) {
                if(this.options.barSize && (x < this.left+this.xPadding  || x > this.xSize+this.xPadding+this.left)){
                    return null;
                }
                pos = x;
            } else {
            ...
            return Math.min(this.data.length - 1, Math.floor((pos - (this.xPadding + this.xStart)) / (this.xSize / this.data.length)));
        };
        ...
        Bar.prototype.hoverContentForRow = function (index) {
            ...
            content = content.prop('outerHTML');
            _ref = row.y;
            for (j = _i = (_ref.length-1); _i >= 0; j = --_i) {
                y = _ref[j];
                if (this.options.labels[j] === false) {
                    continue;
                }
            ...
            if (!this.options.horizontal) {
                x = this.xPadding + this.left + (index + 0.5) * this.xSize / this.data.length;
                return [content, x];
            } else {
    ...
    Morris.Donut = (function (_super) {
        ...
        Donut.prototype.redraw = function () {
            ...
            for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
                ...
                seg.on('hover', this.hover);
                seg.on('hoverout', this.hoverOut);
            ...
            for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                value = _ref2[_k];
                if (value === max_value) {
                    //showDefault is my own property to decide show default segment selected or not. defualt value is true. but for some it will come as false.
                    if ((this.options.showDefault !== undefined && this.options.showDefault === false) || (this.options.showMyDefaultLabelValueFirstTime !== undefined && this.options.showMyDefaultLabelValueFirstTime === true)) {
                        break;
                    } else {
                        this.select(idx);
                        break;
            ...
            //Myself introduced
            if (this.options.isDeselectConfigured === true) {
                this.deselect(idx);
            }
            if (this.options.showMyDefaultLabelValueFirstTime !== undefined && this.options.showMyDefaultLabelValueFirstTime === true) {
                this.setLabels(this.options.defaultSelectText !== undefined ? this.options.defaultSelectText : 'All', (this.options.defaultSelectData !== undefined && this.options.defaultSelectData !== null) ? this.options.defaultSelectData : '');
            }
            return _results;
        };
        ...
        Donut.prototype.setData = function (data, defaultSelectData = null, defaultSelectText = null) {//options has added to update the center text.thaya
            ...
            if (defaultSelectData !== null && defaultSelectData !== undefined)//here we update the defaultSelectData to change the center text values.thaya
                this.options.defaultSelectData = defaultSelectData;
            if (defaultSelectText !== null && defaultSelectText !== undefined)//here we update the defaultSelectText to change the center text values.thaya
                this.options.defaultSelectText = defaultSelectText;
        ...
        Donut.prototype.hover = function (idx) {
            //console.log('kkk hover ', idx);
            return this.fire('hover', idx, this.data[idx]);
        };
        Donut.prototype.hoverOut = function (idx) {
            //console.log('kkk onHoverOut ', idx);
            //console.log('calling deselect on hoverOut - make it configurable');
            if (this.options.isDeselectConfigured === true) {
                this.deselect(idx);
            }
            return this.fire('hoverOut', idx, this.data[idx]);
        };
        Donut.prototype.select = function (idx) {
            ...
            // $("div[id^='Donut_']").toggleClass('highlighthover', false);
            // if (this.data[idx]) {
            //     //console.log("Id which is used in designing div "+this.data[idx].id);
            //     $("#Donut_" + this.data[idx].id).toggleClass('highlighthover', true);
            // }
        ...
        //Introduced myself - this call will be called only isDeselectConfigured== true. currently it's called on hoverOut segment and and default selection for the first time redraw'
        ...
        Donut.prototype.setLabels = function (label1, label2) {
            ...
            this.text1.attr({
                text: label1,
                transform: '',
                'font-family': 'roboto-light' //WebApp Modified
            });
    ...
    Morris.DonutSegment = (function (_super) {
        ...
        DonutSegment.prototype.drawDonutSegment = function (path, fillColor, strokeColor, hoverFunction, clickFunction, hoverOutFunction) {
            return this.raphael.path(path).attr({
                fill: fillColor,
                stroke: strokeColor,
                'stroke-width': 3,
        ...
        DonutSegment.prototype.select = function () {
            if (!this.selected) {
                this.seg.attr('cursor', 'pointer'); //WebApp Modified
                this.seg.animate({
        ...
        DonutSegment.prototype.deselect = function () {
            if (this.selected) {
                this.seg.attr('cursor', ''); //WebApp Modified
                this.seg.animate({
                    path: this.path
                }, 150, '<>');
                this.arc.animate({
